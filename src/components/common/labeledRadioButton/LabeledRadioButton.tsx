...
export interface LabeledRadioButtonProps<T extends string | number | boolean = string> {
  label?: string;
  iconSize?: number;
...
export default function LabeledRadioButton<T extends string | number | boolean = string>({
  label,
  iconSize = 24,
  optionType = "radio",
  value,
